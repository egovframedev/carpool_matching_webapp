...
<div class="content-wrapper">
	<div class="container">
		...
		<section class="content-header">
			<h1>
				<i class="fa fa-user-plus"></i> 회원 가입 <small>회원 가입 폼</small>
			</h1>
			<ol class="breadcrumb">
						...
						<form:form role="form" commandName="memberDTO" id="joinForm"
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="userid" class="form-control"
											id="userid" placeholder="아이디 입력.." required="required">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="password" name="userpw" class="form-control"
											id="userpw" placeholder="비밀번호 입력.." required="required">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="email" name="email" class="form-control"
											id="email" placeholder="입력 예) user01@example.com"
											required="required">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="phone" class="form-control"
											id="phone" placeholder="입력 예) 010-1111-1111"
											required="required">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<label class="radio-inline"> <input type="radio"
											name="gender" id="genderM" value="MALE"> 남자
										</label> <label class="radio-inline"> <input type="radio"
											name="gender" id="genderF" value="FEMALE"> 여자
										</label>
									</div>
								</div>
							</div>
							<div class="box-footer">
								<button class="btn btn-default pull-left"
									...
									<i class="fa fa-reply" aria-hidden="true"></i> 취소
								</button>
								<button id="joinBtn" class="btn btn-primary pull-right">
									<i class="fa fa-check-square-o" aria-hidden="true"></i> 회원 가입
								</button>
							</div>
						</form:form>
					</div>
