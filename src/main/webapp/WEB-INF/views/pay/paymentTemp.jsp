...
<!-- 	int amount;
	String payno,apply_num;
	Date pay_date; -->
    <!-- Main content -->
	<button id="check_module" type="button">payment</button>
	<form action='<c:url value='/'/>pay/insertReg' method="POST">
	<input type="hidden" id="merchant_uid" name="payno">
	<input type="hidden" id="paid_amount" name="amount" >
