		...
		<section class="content-header">
			...
			<section class="content-header">
				<h1><i class="fa fa-slideshare" aria-hidden="true"></i>
					결제 완료<small>여정 평가 하기</small></h1>
				<ol class="breadcrumb">
					<li><a href="<c:url value='/carpool/riding'/>"><i class="fa fa-dashboard"></i> 결제 완료</a></li>
					<li class="active">여정 평가 하기</li>
				</ol>
			</section>
		</section>
    	<!-- Main content -->
        		...
        		<div class="col-xs-8 col-xs-offset-2">
          			<div class="box box-danger">
						<div class="box-header with-border">
							<h3 class="box-title">여정이 완료 되었습니다.</h3>
						</div>
						<div class="box-body text-center">
							<p>
								<span>${cpjoin.carpool.startPoint}</span>
								<i class="fa fa-long-arrow-right" aria-hidden="true"></i>
								<span>${cpjoin.carpool.endPoint}</span>
							</p>
							<div>
								<span>총 결제금액</span>
								<h4>${payDTO.amount}원</h4>
							</div>
					...
					<div class="box box-primary">
						...
						<div class="box-footer text-center">
							<button class="btn btn-success btn-lg" type="submit">평가하기</button>
						</div>
	                    </form>
					</div>
        		</div><!-- /.col -->
