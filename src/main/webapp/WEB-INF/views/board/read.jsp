		...
		<section class="content">
			<div class="box box-success">			
				...
				<c:if test="${login.uid == boardVO.writer}">				
					...
					<button type="button" class="btn btn-primary" id="btnAnswer"><i class="fa fa-pencil"></i> 답글 달기</button>&nbsp;&nbsp;
...
<script>
	...
	$(document).ready(function(){
		...
		$.getJSON("/xboard/getAttach/" + bno, function(list){
			$(list).each(function(){
		...
		$("#btnList").on("click", function(){
			formObj.attr("action", "/xboard/list");
		...
		$("#btnAnswer").on("click", function(){
			formObj.attr("action", "/xboard/answer");
			formObj.attr("method", "get");
			formObj.submit();
		});
		...
		$("#btnModify").on("click", function(){
			formObj.attr("action", "/xboard/modify");
			formObj.attr("method", "get");
			formObj.submit();
		});
		...
		$("#btnRemove").on("click", function(){
			...
			if(delConfirm) { 
				...
				formObj.attr("action", "/xboard/remove");
				formObj.submit();
			}
		});
